...
class _ShoppingScreenState extends State<ShoppingScreen> {
  // Use localized names so the app follows the current language.
  List<Product> _products(AppLocalizations l10n) {
    return [
      Product(
        name: l10n.lilyBouquet,
        imageUrl:
  ...
  Widget build(BuildContext context) {
    ...
    final products = _products(l10n);

    // One scroll keeps all sections together on small screens.
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color(0xFFC7A0BF),
        title: AppTitle(text: AppLocalizations.of(context)!.products),
        centerTitle: true,
      ),
